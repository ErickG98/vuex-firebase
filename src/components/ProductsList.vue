    ...
    <div class="card border-dark shadow">
        ...
        <div class="card-body text-center">
            <div class="table-responsive">
                ...
                <tbody v-for="p in products" :key="p.id">
                    <td><img v-bind:src="p.img" alt="img" width="50" height="50"></td>
                    <td>{{p.name}}</td>
                    <td>${{parseFloat(p.price).toFixed(2)}}</td>
                    <td>{{p.stock}}</td>
                    <td>
                        <div class="d-flex justify-content-around">
                            <button type="button" @click="chargeData(p), editing = true" class="btn btn-warning" style="border-radius: 50%">
                            ...
                            <button type="button" @click="deleteProduct(p.id)" class="btn btn-danger" style="border-radius: 50%">
